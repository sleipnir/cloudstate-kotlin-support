...
class CloudStateInitializer {
    ...
    fun registerEventSourcedEntity(eventSourcedInitializer: EventSourcedEntityInitializer.() -> Unit) {
        ...
        eventSourcedInit?.statefulService?.let { services.put(eventSourcedInit.descriptor?.fullName, EntityFunction(eventSourcedInit, eventSourcedInit.type?.typeStr, eventSourcedInit.descriptor?.fullName)) }
    }
